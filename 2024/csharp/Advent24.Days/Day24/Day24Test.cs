...
{
    public class Day24Test : SteppedTestEngine<Day24Solver, Circuit, Circuit, long, string>
    {
        private const long EXPECTED_SOLUTION_PART_1 = 47666458872582L;
        private const string EXPECTED_SOLUTION_PART_2 = "abc";
        ...
        {
            var input = new Day24Solver().ParseInputOne(EXAMPLE_ONE_2);
